...
def json_file_of_flashcard_from_string(stringOfPDF):
    question =  "Create a set of flashcards from PDF making sure to cover every topic. Please format the tags as follows:\n\"Frontside\": (Front of the card)\n\"Backside\": (Back of the card)\n\"Topic\": (The topic of the question)\n"
